...
from my_pandas_extensions.forecasting import arima_forecast, data_prep, LSTM_forecast
...
state_sales_df = summarize_by_time(
    data = df,
    date_column = "order_date",
    groups= 'state',
    value_column = "total_price",
...
state_arima_pred = arima_forecast(
    data = state_sales_df,
    h = 3,
    sp = 1,
    coverage = 0.95,
...
Arima_forcast = pd.concat([Cat_1_arima_pred_df, Cat_2_arima_pred_df, state_sales_df], axis = 0, ignore_index= True ) 


Cat_1_arima_pred_df['Index'] = Cat_1_arima_pred_df['category_1']

Cat_1_arima_pred_df.to_csv('04_artifacts/Cat_1_arima_pred.csv')


Cat_2_arima_pred_df['Index'] = Cat_2_arima_pred_df['category_2']

Cat_2_arima_pred_df.to_csv('04_artifacts/Cat_2_arima_pred.csv')

state_arima_pred['Index'] = state_arima_pred['state'] 
state_arima_pred.to_csv('04_artifacts/state_arima_pred.csv')
...
LSTM_forecast(group, WINDOW_SIZE, BATCH_SIZE, shuffle_buffer_size, train_rate, dev_rate)
