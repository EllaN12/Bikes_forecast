...
def forecast_data_pull(total = False, Mountain = False, Road = False, bikeshop = False):
    ...
    # total
    file_path = '/Users/ellandalla/Desktop/Bikes_forecast/venv/04_artifacts/total_prediction.pkl'
...
=======
    file_path = '/Users/ellandalla/Desktop/Bikes_forecast/venv/04_artifacts/cat_1_prediction.pkl'
>>>>>>> e5eef7981 (gathering requirements)
    with open(file_path, 'rb') as f:
...
=======
    file_path = '/Users/ellandalla/Desktop/Bikes_forecast/venv/04_artifacts/cat_2_prediction.pkl'
>>>>>>> e5eef7981 (gathering requirements)
    with open(file_path, 'rb') as f:
...
=======
    file_path = '/Users/ellandalla/Desktop/Bikes_forecast/venv/04_artifacts/bikeshop_prediction.pkl'
>>>>>>> e5eef7981 (gathering requirements)
