...
bikeshop = df[df['order_date'].dt.year == 2015]\
    .summarize_by_time(
        ...
        .reset_index()\
        .melt(
            id_vars = ['bikeshop_name', 'order_date'],
            value_vars = ['total_price', 'quantity'],
            #var_name = 'Metric',
            value_name = '.Value')
        
    
bikeshop2 = pivot_longer(bikeshop, index = 'bikeshop_name', columns = ['total_price', 'quantity'], values_to = '.Value')   
