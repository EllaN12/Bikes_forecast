...
dropdown = dbc.DropdownMenu(
    ...
    label="Category",
    children=[
        dbc.DropdownMenuItem("Overview", id="Overview-option", n_clicks=0),
...
app.layout = dbc.Container([
    ...
    dbc.Row([html.Div(
                    id="intro",
                    children="Review of bike sales data for FY2015 and forecast for Q12016 across various bike categories, sub- and stores."
                )]),
    dbc.Row([
        dbc.Col([
            html.Div([
