...
dropdown2 = dcc.DropdownMenu(
    id="sub-categories_dropdown",
    label="Sub-Categories",
    children=[
        dbc.DropdownMenuItem("Total", id="Total-option", n_clicks=0), if dropdown == 'Total',
        dbc.DropdownMenuItem("Mountain", id="Mountain-option", n_clicks=0) for x in Mountain if dropdown == 'Mountain',
        dbc.DropdownMenuItem("Road", id="Road-option", n_clicks=0) for x in Road if dropdown == 'Road',
        dbc.DropdownMenuItem("Bikeshops", id="Bikeshops-option", n_clicks=0) for x in bikeshop_name if dropdown == 'Bikeshops',
    ],
)
